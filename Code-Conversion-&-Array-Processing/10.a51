...
;smaller of these two will be placed at the first location, this way first element is compared with all elements one by one and thus, the smallest
...
;this element is compared with rest of the array elements and in this way, the next smallest element is brought to the second element. This
