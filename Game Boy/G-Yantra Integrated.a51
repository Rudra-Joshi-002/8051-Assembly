...
;also the follwing register banks have been used 
...
org 0010h
	...
	orl tcon,#01h ;Set External Interrupt-0 Bit as Edge Trigerred
...
org 0064h ;here lies the codes for GLCD and GUI Related Operations
	...
	display_char: ;subroutine to display a charcter 
	;form lookup table r5,r0 of reg bak 0 used
	...
	;r2 of reg b3
		...
		;command for slecting 0th column in glcd
...
org 079dh
	...
	gui: ; functions to provide a basic subroutine
		...
		mov ie,#81h ;enable external interupt at 
	...
	;1dh reg-5 of RB-3->tores the score of snake
	...
	;x=columns= 8x8 grid columns of glcd (0-fh)
		...
		;set the intial coordinates of snake: 
		...
		mov 1dh,#00 ;seting the score register to 
		;zero immdiate value at start of game
	...
	;snakes body exluding head
		...
		;1st element immediately behind head of middle segment
	...
	;need to chage r6
		...
		check_overlap: 
			...
			;generated conrolled random food coordinate 
		...
		;that is stored in 30h (r0 points 30h) in 20h
			  ...
			  cjne a,20h,finally_done ;check for 1 elemnt as r4=1 
			  ;and if no overlapping then done otherwise nxt_coord
		...
		;in r0 so now it point to 31h
					 ...
					 mov 20h,@r0 ;mov value stored in 31h 
					 ;in 20h
					 
					 djnz r4,do_again ;repeat for r4 times 
					 ;i.e if body length is 2 then r4=2 and 
					 ;this will repeat for 30h and 31h 
						
					 pop 14h ;pop r4
					 pop 10h ; pop r0
						
					 sjmp finally_done ;if till here it has 
					 ;not jumped to nxt_coord this means 
					 ;there is no overlapping so we are good to go
		...
		check_again: movc a,@a+dptr	;thus from the stored 
		;values choose 4th one
					 
				 sjmp check_overlap ;as it entered 
				 ;nxt_coord it meant there was overlaping 
	...
	;diplays the 2-digit code form 0-99 in decimal number system
	;so yes this code can show you correct scores only for 
	;values form 0-99 in decimal also the logic used to 
	...
	;One Can Refer that for that logic understanting
		...
		go_to_display:
			...
			;push acc ;push the digit value of 
			;10's or 1's place on stack
...
org 0d00h
	...
	;_4_in_a_row game starts here
		...
		;seletcted this bit is used to indicate that
		...
		;data present in them means the follwing things:
	...
	display_grid_4IR:
		...
		nxt_4IR:
			...
			mov a,r5 ;display grind character at 
	...
	;the coin after select button is pressed  		
		...
		jb 01h,pl2_2 ; jump if 01h is set , if its set then p1 
		...
		;we follow an invereted logic here
	...
	fill_cell_4IR:;r1 points to 21h, 21h to 27h 
	...
	;correspoding to the grid filled by a given player
		...
		jb 01h,updt_p2 ;to take apt decision as to 
	...
	score_check_4IR:
		...
		;possiblity with currently filled element
	...
	check_vertical: ;check the winning possiblity vertically
		...
		jc continue_vertical ; if after subtracttion 
